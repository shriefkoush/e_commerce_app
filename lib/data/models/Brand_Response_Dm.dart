...
class BrandResponseDm extends BrandResponseEntity {
  ...
  BrandResponseDm.fromJson(dynamic json) {
    ...
    metadata = json['metadata'] != null ? MetadataBrandDm.fromJson(json['metadata']) : null;
    if (json['data'] != null) {
      data = [];
      json['data'].forEach((v) {
...
class MetadataBrandDm extends MetadataBrandEntity{
  MetadataBrandDm({
      super.currentPage,
      super.numberOfPages,
      super.limit,
  ...
  MetadataBrandDm.fromJson(dynamic json) {
